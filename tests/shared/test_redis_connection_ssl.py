...
# Redis credentials - using the SSL/TLS endpoint format for Upstash
REDIS_URL = "rediss://default:AUUnAAIncDI1ZWRkMmFkMDE2ZjA0MmYxYmEyNWVlYzM1Y2ExODMxNHAyMTc3MDM@adjusted-sunbird-17703.upstash.io:6383"

print(f"Attempting to connect to Redis with SSL: {REDIS_URL}")
...
try:
    ...
    print(f"Connecting to Redis host: {host}:{port} with SSL")
    
    # Create Redis connection using individual components with SSL
