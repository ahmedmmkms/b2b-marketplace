...
export class CacheAdaptor {
    ...
    switch (s.value?.kind) {
      case 'FETCH': {
        ...
        return (e ? [...o, ...e] : getDerivedTags(o)).some((d) => {
          ...
          return g?.revalidatedAt && g?.revalidatedAt >= (s.lastModified ?? Date.now());
        })
          ? null
          : s;
      }
  ...
  async loadTagsManifest(t = !1) {
    !(t || !this.tagsManifest) ||
      (this.tagsManifestPromise || (this.tagsManifestPromise = this.loadTagsManifestInternal()),
  ...
  async loadTagsManifestInternal() {
    ...
    ((this.tagsManifest ??= { version: 1, items: {} }), (this.tagsManifestPromise = void 0));
  }
  ...
  async setTags(t, { cacheKey: e, revalidatedAt: a }) {
    ...
    for (const i of t) {
      ...
      (e && !s.keys.includes(e) && s.keys.push(e), a && (s.revalidatedAt = a), (n.items[i] = s));
    }
