...
var Z = (i, p) => () => (i && (p = i((i = 0))), p);
var W = (i, p, L, j) => {
    if ((p && typeof p == 'object') || typeof p == 'function')
      for (let x of Y(p))
        !J.call(i, x) &&
          x !== L &&
          V(i, x, { get: () => p[x], enumerable: !(j = X(p, x)) || j.enumerable });
    return i;
  },
  G = (i, p, L) => (W(i, p, 'default'), L && W(L, p, 'default'));
var nn = (i) => W(V({}, '__esModule', { value: !0 }), i);
var K = {};
...
import { __getNamedExports as tn } from '../../../__next-on-pages-dist__/webpack/6405.js';
import { __getNamedExports as _n } from '../../../__next-on-pages-dist__/webpack/1746.js';
import { __getNamedExports as cn } from '../../../__next-on-pages-dist__/webpack/3290.js';
...
var h = globalThis.__nextOnPagesRoutesIsolation.getProxyFor('/[lng]/quotes'),
  dn = en(h, h, h),
  ln = dn.__chunk_8586,
  hn = tn(h, h, h),
  kn = hn.__chunk_6405,
  ...
  Pc = n.__chunk_2181,
  z = un(h, h, h),
  Ec = z.__NEXT_FONT_MANIFEST,
  vc = z.__REACT_LOADABLE_MANIFEST,
  Nc = z.__BUILD_MANIFEST,
  Rc = z.__RSC_SERVER_MANIFEST,
  $c = ((i, p, L) => (
    (p._ENTRIES = {}),
    (i.__RSC_SERVER_MANIFEST = Rc),
    (p.__RSC_MANIFEST = p.__RSC_MANIFEST || {}),
    (p.__RSC_MANIFEST['/[lng]/quotes/page'] = {
      ...
      clientModules: {
        ...
        '/mnt/d/Projects/b2b-marketplace/frontend/components/common/app-shell.tsx': {
          ...
          chunks: [
            ...
            '283',
            'static/chunks/app/%5Blng%5D/quotes/page-7048e3f0d0bae827.js',
          ],
          async: !1,
        },
      ...
      entryCSSFiles: {
        ...
        '/mnt/d/Projects/b2b-marketplace/frontend/app/[lng]/quotes/page': [],
      },
    }),
    (i.__BUILD_MANIFEST = Nc),
    (i.__REACT_LOADABLE_MANIFEST = vc),
      ...
      ((t.m = j),
        ...
        (() => {
          ...
          t.O = (u, c, d, g) => {
            if (c) {
              g = g || 0;
              for (var k = e.length; k > 0 && e[k - 1][2] > g; k--) e[k] = e[k - 1];
              e[k] = [c, d, g];
              return;
            }
            for (var b = 1 / 0, k = 0; k < e.length; k++) {
              for (var [c, d, g] = e[k], P = !0, v = 0; v < c.length; v++)
                b >= g && Object.keys(t.O).every((M) => t.O[M](c[v]))
                  ? c.splice(v--, 1)
                  : ((P = !1), g < b && (b = g));
              if (P) {
                e.splice(k--, 1);
        ...
        (() => {
          var e,
            u = Object.getPrototypeOf ? (c) => Object.getPrototypeOf(c) : (c) => c.__proto__;
          t.t = function (c, d) {
            if (
              (1 & d && (c = this(c)),
              8 & d ||
                (typeof c == 'object' &&
                  c &&
                  ((4 & d && c.__esModule) || (16 & d && typeof c.then == 'function'))))
            )
              return c;
            ...
            var k = {};
            e = e || [null, u({}), u([]), u(u)];
            for (var b = 2 & d && c; typeof b == 'object' && !~e.indexOf(b); b = u(b))
              Object.getOwnPropertyNames(b).forEach((P) => (k[P] = () => c[P]));
            return ((k.default = () => c), t.d(g, k), g);
          };
        })(),
        (t.d = (e, u) => {
          for (var c in u)
            t.o(u, c) && !t.o(e, c) && Object.defineProperty(e, c, { enumerable: !0, get: u[c] });
        }),
        (t.e = () => Promise.resolve()),
        (t.g = (function () {
        ...
        (() => {
          ...
          var u = (d, g) => {
              var k,
                ...
                a = 0;
              if (P.some((q) => e[q] !== 0)) {
                for (k in v) t.o(v, k) && (t.m[k] = v[k]);
                if (r) var w = r(t);
              }
              for (d && d(g); a < P.length; a++)
                ((b = P[a]), t.o(e, b) && e[b] && e[b][0](), (e[b] = 0));
              return t.O(w);
            },
            c = (i.webpackChunk_N_E = i.webpackChunk_N_E || []);
          (c.forEach(u.bind(null, 0)), (c.push = u.bind(null, c.push.bind(c))));
        })());
    })(),
    ...
    (i.webpackChunk_N_E = i.webpackChunk_N_E || []).push([
      [283],
      {
        ...
        6418: (j, x, t) => {
          'use strict';
          (t.r(x), t.d(x, { ComponentMod: () => s, default: () => S }));
          var e,
            u = {};
          (t.r(u),
            t.d(u, {
              ...
              GlobalError: () => v.ZP,
              LayoutRouter: () => r.yO,
              NotFoundBoundary: () => r.O4,
              Postpone: () => r.hQ,
              RenderFromTemplateContext: () => r.b5,
              __next_app__: () => F,
              actionAsyncStorage: () => r.Wz,
              createDynamicallyTrackedSearchParams: () => r.rL,
              createUntrackedSearchParams: () => r.S5,
              decodeAction: () => r.Hs,
              decodeFormState: () => r.dH,
              decodeReply: () => r.kf,
              originalPathname: () => q,
              pages: () => w,
              patchFetch: () => r.XH,
              ...
              preloadFont: () => r.C5,
              preloadStyle: () => r.oH,
              renderToReadableStream: () => r.aW,
              requestAsyncStorage: () => r.Fg,
              routeModule: () => M,
              serverHooks: () => r.GP,
              staticGenerationAsyncStorage: () => r.AT,
              taintObjectReference: () => r.nr,
              tree: () => a,
            }),
            t(4833));
          var c = t(9004),
          ...
          let a = [
                    ...
                    children: [
                      'quotes',
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(t.bind(t, 7956)),
                              '/mnt/d/Projects/b2b-marketplace/frontend/app/[lng]/quotes/page.tsx',
                            ],
                          },
                        ],
                      },
            ...
            w = ['/mnt/d/Projects/b2b-marketplace/frontend/app/[lng]/quotes/page.tsx'],
            q = '/[lng]/quotes/page',
            F = { require: t, loadChunk: () => Promise.resolve() },
            M = new b.AppPageRouteModule({
              definition: {
                kind: P.x.APP_PAGE,
                page: '/[lng]/quotes/page',
                pathname: '/[lng]/quotes',
                bundlePath: '',
                filename: '',
                appPaths: [],
          ...
          var $ = t(8388),
            B = t(4527),
            N = t(1518);
          let R = (f) => (f ? JSON.parse(f) : void 0),
            A = i.__BUILD_MANIFEST,
            D = R(i.__PRERENDER_MANIFEST),
            E = R(i.__REACT_LOADABLE_MANIFEST),
            T = (e = i.__RSC_MANIFEST) == null ? void 0 : e['/[lng]/quotes/page'],
            y = R(i.__RSC_SERVER_MANIFEST),
            _ = R(i.__NEXT_FONT_MANIFEST),
            l = R(i.__INTERCEPTION_ROUTE_REWRITE_MANIFEST) ?? [];
          T &&
            y &&
            (0, B.Mo)({
              clientReferenceManifest: T,
              serverActionsManifest: y,
              serverModuleMap: (0, N.w)({
                serverActionsManifest: y,
                pageName: '/[lng]/quotes/page',
              }),
            });
          let o = (0, d.d)({
              pagesType: $.s.APP,
            ...
            s = u;
          function S(f) {
            return (0, c.C)({ ...f, IncrementalCache: g.k, handler: o });
          }
        },
        1290: (j, x, t) => {
          (Promise.resolve().then(t.bind(t, 7508)), Promise.resolve().then(t.bind(t, 5069)));
        },
        7508: (j, x, t) => {
          'use strict';
          t.d(x, { QuoteInbox: () => B });
          var e = t(3408),
            ...
            a = t(6405),
            w = t(8586);
          let q = ({ quotes: N, currency: R = 'USD', onAccept: A, isAccepting: D }) => {
            let E = (0, d.T_)('quotes.compare'),
              T = (0, d.T_)('common.actions'),
              y = (0, g.bU)();
            return N?.length
              ? (0, e.jsxs)(r.Card, {
                  className: 'border-border',
                  children: [
                    (0, e.jsx)(r.Ol, { children: (0, e.jsx)(r.ll, { children: E('title') }) }),
                    (0, e.jsx)(r.CardContent, {
                      className: 'overflow-x-auto',
                      children: (0, e.jsxs)(a.iA, {
                        children: [
                          (0, e.jsx)(a.xD, {
                            children: (0, e.jsxs)(a.SC, {
                              children: [
                                (0, e.jsx)(a.ss, { children: E('vendor') }),
                                (0, e.jsx)(a.ss, { children: E('unitPrice') }),
                                (0, e.jsx)(a.ss, { children: E('leadTime') }),
                                (0, e.jsx)(a.ss, { children: E('shipping') }),
                                (0, e.jsx)(a.ss, { children: E('total') }),
                                (0, e.jsx)(a.ss, {}),
                              ],
                            }),
                          }),
                                ...
                                a.SC,
                                {
                                  children: [
                                    (0, e.jsx)(a.pj, {
                                      ...
                                      children: _.vendorName ?? _.vendorId ?? '-',
                                    }),
                                    (0, e.jsx)(a.pj, {
                                      children: (0, w.xG)(_.subtotal ?? 0, _.currency ?? R, y),
                                    }),
                                    (0, e.jsx)(a.pj, {
                                      children:
                                        _.lines?.[0]?.leadTimeDays != null
                                          ? `${_.lines?.[0]?.leadTimeDays} d`
                                          : '-',
                                    }),
                                    (0, e.jsx)(a.pj, {
                                      children: (0, w.xG)(_.taxTotal ?? 0, _.currency ?? R, y),
                                    }),
                                    (0, e.jsx)(a.pj, {
                                      children: (0, w.xG)(_.grandTotal ?? 0, _.currency ?? R, y),
                                    }),
                                    (0, e.jsx)(a.pj, {
                                      className: 'text-right',
                                      children: (0, e.jsx)(v.Button, {
                                        size: 'sm',
                                        onClick: () => A?.(_),
                                        disabled: D,
                                        children: T('accept'),
          ...
          let B = () => {
            let N = (0, d.T_)('quotes'),
              R = (0, d.T_)('common.actions'),
              A = (0, g.bU)(),
              D = (0, d.T_)('common.status'),
              E = (0, c.tv)(),
              [T, y] = (0, u.useState)(''),
              [_, l] = (0, u.useState)(''),
              { data: o, isLoading: s, refetch: S } = (0, M.iQ)(_, { query: { enabled: !!_ } }),
              f = o ?? [],
              I = (0, M.iY)({
                mutation: {
                  onSuccess: () => {
                    (k.Am.success('Quote accepted', {
              ...
              O = async (m) => {
                if (!m.id) {
                  k.Am.error('Quote is missing an id and cannot be accepted.');
                  return;
                }
                try {
                  await I.mutateAsync({ rfqId: _, quoteId: m.id });
                } catch (C) {
                  (0, $.Hv)(C);
                }
              };
            return (0, e.jsxs)('div', {
              ...
              children: [
                ...
                (0, e.jsxs)(r.Card, {
                  children: [
                    (0, e.jsx)(r.Ol, { children: (0, e.jsx)(r.ll, { children: N('title') }) }),
                    (0, e.jsxs)(r.CardContent, {
                      className: 'space-y-4',
                      children: [
                        s
                          ? (0, e.jsx)('p', {
                        ...
                        f.length
                          ? (0, e.jsxs)(e.Fragment, {
                              children: [
                                (0, e.jsx)(q, {
                                  quotes: f,
                                  currency: f[0]?.currency ?? 'USD',
                                  onAccept: O,
                                  isAccepting: I.isPending,
                                }),
                                (0, e.jsx)('div', {
                                  children: (0, e.jsxs)(a.iA, {
                                    children: [
                                      (0, e.jsx)(a.xD, {
                                        children: (0, e.jsxs)(a.SC, {
                                          children: [
                                            (0, e.jsx)(a.ss, { children: N('compare.vendor') }),
                                            (0, e.jsx)(a.ss, { children: 'Status' }),
                                            (0, e.jsx)(a.ss, { children: N('compare.total') }),
                                            (0, e.jsx)(a.ss, { children: 'Valid until' }),
                                          ],
                                        }),
                                      }),
                                      (0, e.jsx)(a.RM, {
                                        children: f.map((m) =>
                                          (0, e.jsxs)(
                                            a.SC,
                                            {
                                              children: [
                                                (0, e.jsx)(a.pj, {
                                                  children: m.vendorName ?? m.vendorId ?? '-',
                                                }),
                                                (0, e.jsx)(a.pj, { children: D(m.status) }),
                                                (0, e.jsx)(a.pj, {
                                                  children: (0, w.xG)(
                                                    m.grandTotal ?? 0,
                                                    m.currency ?? 'USD',
                                                ...
                                                (0, e.jsx)(a.pj, {
                                                  children: m.validUntil
                                                    ? (0, w.p6)(m.validUntil, A)
                                                    : '-',
                                                }),
                                              ],
                                            },
        ...
        7956: (j, x, t) => {
          'use strict';
          (t.r(x), t.d(x, { default: () => P }));
          var e = t(9154),
            u = t(336),
            c = t(1298);
          let d = (0, c.D)(
              String.raw`/mnt/d/Projects/b2b-marketplace/frontend/app/[lng]/quotes/quote-inbox.tsx`,
            ),
            { __esModule: g, $$typeof: k } = d;
          d.default;
          let b = (0, c.D)(
            String.raw`/mnt/d/Projects/b2b-marketplace/frontend/app/[lng]/quotes/quote-inbox.tsx#QuoteInbox`,
          );
          function P() {
            return (0, e.jsx)(u.V, { children: (0, e.jsx)(b, {}) });
          }
        },
      },
      (j) => {
        ...
        (p._ENTRIES = typeof p._ENTRIES > 'u' ? {} : p._ENTRIES)[
          'middleware_app/[lng]/quotes/page'
        ] = t;
      },
    ]),
    function () {
      let j = { exports: {}, loaded: !1 };
      return (
        (function (t, e) {
          var u = Object.create,
            ...
            P = (_) => c(_, '__esModule', { value: !0 }),
            v = (_, l) => {
              P(_);
              for (var o in l) c(_, o, { get: l[o], enumerable: !0 });
            },
            r = (_, l, o) => {
              if ((l && typeof l == 'object') || typeof l == 'function')
                for (let s of g(l))
                  !b.call(_, s) &&
                    s !== 'default' &&
                    c(_, s, { get: () => l[s], enumerable: !(o = d(l, s)) || o.enumerable });
              return _;
            },
            a = (_) =>
              r(
          ...
          v(e, { default: () => D });
          var w = a((Q(), nn(K))),
            q = '@next/request-context',
            F = Symbol.for(q),
            M = Symbol.for('internal.storage');
          function $() {
            let _ = p;
            if (!_[F]) {
              let l = new w.AsyncLocalStorage(),
                o = { get: () => l.getStore(), [M]: l };
              _[F] = o;
            }
            return _[F];
          }
          ...
          function R(_) {
            ...
            return (
              _ &&
                _.forEach((o, s) => {
                  ((l[s] = o), s.toLowerCase() === 'set-cookie' && (l[s] = A(o)));
                }),
              l
            );
          }
          function A(_) {
            let l = [],
              ...
              O;
            function m() {
              for (; o < _.length && /\s/.test(_.charAt(o)); ) o += 1;
              return o < _.length;
            }
            function C() {
              return ((S = _.charAt(o)), S !== '=' && S !== ';' && S !== ',');
            }
            for (; o < _.length; ) {
              for (s = o, O = !1; m(); )
                if (((S = _.charAt(o)), S === ',')) {
                  for (f = o, o += 1, m(), I = o; o < _.length && C(); ) o += 1;
                  o < _.length && _.charAt(o) === '='
                    ? ((O = !0), (o = I), l.push(_.substring(s, f)), (s = o))
                    : (o = f + 1);
                } else o += 1;
              (!O || o >= _.length) && l.push(_.substring(s, _.length));
            }
            return l;
          }
          function D(_) {
            let l = _.staticRoutes.map((s) => ({ regexp: new RegExp(s.namedRegex), page: s.page })),
              o =
                _.dynamicRoutes?.map((s) => ({ regexp: new RegExp(s.namedRegex), page: s.page })) ||
                [];
            return async function (s, S) {
              let f = new URL(s.url).pathname,
                I = {};
              if (
                (_.nextConfig?.basePath &&
                  f.startsWith(_.nextConfig.basePath) &&
                  (f = f.replace(_.nextConfig.basePath, '') || '/'),
                _.nextConfig?.i18n)
              )
                for (let m of _.nextConfig.i18n.locales) {
                  let C = new RegExp(`^/${m}($|/)`, 'i');
                  if (f.match(C)) {
                    f = f.replace(C, '/') || '/';
                    break;
                  }
              ...
              if (!I.name) {
                let m = T(f);
                for (let C of o || []) {
                  if (m && !T(C.page)) continue;
                  let H = C.regexp.exec(f);
                  if (H) {
                    I = { name: C.page, params: H.groups };
                    break;
                  }
                }
              }
              let O = await N({ waitUntil: S.waitUntil }, () =>
                p._ENTRIES[`middleware_${_.name}`].default.call(
                  {},
                  {
                    request: {
                      url: s.url,
                      ...
                      ip: E(s.headers, y.Ip),
                      geo: {
                        city: E(s.headers, y.City, !0),
                        country: E(s.headers, y.Country, !0),
                        latitude: E(s.headers, y.Latitude),
                        longitude: E(s.headers, y.Longitude),
                        region: E(s.headers, y.Region, !0),
                      },
              ...
              return (O.waitUntil && S.waitUntil(O.waitUntil), O.response);
            };
          }
          function E(_, l, o = !1) {
            let s = _.get(l) || void 0;
            return o && s ? decodeURIComponent(s) : s;
          }
          function T(_) {
