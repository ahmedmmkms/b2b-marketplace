var N = {},
  g = (x, p, u) => (
    (N.__chunk_6405 = (w, b, o) => {
      'use strict';
      o.d(b, { RM: () => m, SC: () => f, iA: () => d, pj: () => n, ss: () => i, xD: () => c });
      var l = o(3408),
        t = o(9563),
        r = o(164);
      let d = t.forwardRef(({ className: e, ...a }, s) =>
        (0, l.jsx)('div', {
      ...
      d.displayName = 'Table';
      let c = t.forwardRef(({ className: e, ...a }, s) =>
        (0, l.jsx)('thead', { ref: s, className: (0, r.cn)('[&_tr]:border-b', e), ...a }),
      );
      c.displayName = 'TableHeader';
      let m = t.forwardRef(({ className: e, ...a }, s) =>
        (0, l.jsx)('tbody', {
          ref: s,
      ...
      ((m.displayName = 'TableBody'),
        (t.forwardRef(({ className: e, ...a }, s) =>
          (0, l.jsx)('tfoot', {
            ref: s,
            className: (0, r.cn)('bg-muted/50 font-medium text-foreground', e),
            ...a,
          }),
        ).displayName = 'TableFooter'));
      let f = t.forwardRef(({ className: e, ...a }, s) =>
        (0, l.jsx)('tr', {
          ref: s,
          className: (0, r.cn)(
      ...
      let i = t.forwardRef(({ className: e, ...a }, s) =>
        (0, l.jsx)('th', {
          ref: s,
          className: (0, r.cn)(
      ...
      let n = t.forwardRef(({ className: e, ...a }, s) =>
        (0, l.jsx)('td', {
          ref: s,
          className: (0, r.cn)('p-4 align-middle [&:has([role=checkbox])]:pr-0', e),
          ...a,
        }),
      );
