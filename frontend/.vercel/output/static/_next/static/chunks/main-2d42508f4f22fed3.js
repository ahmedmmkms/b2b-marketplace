(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [179],
  {
    ...
    5894: function (e, t, r) {
      'use strict';
      (Object.defineProperty(t, '__esModule', { value: !0 }), r(708));
      let n = r(4185);
      ((window.next = {
        version: n.version,
        get router() {
        ...
        getMiddleware() {
          return (
            (window.__MIDDLEWARE_MATCHERS = [
              ...
              {
                regexp:
                  '^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(en|ar))(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$',
                originalSource: '/(en|ar)/:path*',
              },
            ]),
            window.__MIDDLEWARE_MATCHERS
          );
